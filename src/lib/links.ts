        ...
        },
        {
            ...
            list: [
                ...
                { href: '/docs/tokens', label: 'Design Tokens', keywords: 'theme, color, pairing, css, utility' },
                {
                    href: '/docs/variants',
                    label: 'Variants',
                    keywords: 'variant, variants, presets, backgrounds, classes'
                },
                {
            ...
            list: [
                {
                    href: '/docs/purgecss',
                    label: 'PurgeCSS',
                    keywords: 'purgecss, vite, tree, shaking, bundle, optimize'
                },
    ...
    '/elements': [
        ...
        },
        {
            ...
            list: [
                ...
                { href: '/elements/cards', label: 'Cards', keywords: 'header, footer, background, cell, region' },
                {
                    href: '/elements/chips',
                    label: 'Chips',
                    keywords: 'action, select, selection, filter, filtering, interactive'
                },
                {
                    href: '/elements/lists',
                    label: 'Lists',
        ...
        },
        {
            ...
            list: [
                ...
                {
                    href: '/elements/image-layouts',
                    label: 'Image Layouts',
                    keywords: 'image, layout, blocks, masonry, grid'
                },
                {
                    href: '/elements/scroll-containers',
                    label: 'Scroll Containers',
                    keywords: 'carousel, scroll, snap, container'
                }
            ]
        }
    ],
    '/svelte': [
        ...
        },
        {
            ...
            list: [
                ...
                {
                    href: '/components/conic-gradients',
                    label: 'Conic Gradients',
                    keywords: 'chart, graph, circle, pie, spinner, legend'
                },
                {
                    href: '/components/file-buttons',
                    label: 'File Buttons',
                    keywords: 'upload, form, input, file, media'
                },
                {
                    href: '/components/file-dropzone',
                    label: 'File Dropzone',
                    keywords: 'upload, form, input, file, media, drag, drop'
                },
                {
                    href: '/components/input-chips',
                    label: 'Input Chips',
                    keywords: 'multi, multiple, select, tags, form, validation'
                },
                ...
                {
                    href: '/components/range-sliders',
                    label: 'Range Sliders',
                    keywords: 'value, min, max, step,, tick, input, form'
                },
                {
                    href: '/components/slide-toggles',
                    label: 'Slide Toggles',
                    keywords: 'check, checkbox, toggle, input, form'
                },
        ...
        // Deprecated
        {
            ...
            list: [
                ...
                {
                    href: '/components/steppers',
                    label: 'Steppers',
                    keywords: 'intro, onboard, onboarding, form, progress',
                    badge: 'Deprecated'
                }
            ]
        }
